...
-- -----------------------------------------------------
-- Table `makemeacube`.`UserEvaluation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `makemeacube`.`UserEvaluation` ;

CREATE TABLE IF NOT EXISTS `makemeacube`.`UserEvaluation` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_User_Evaluation_evaluator_idx` (`evaluator` ASC) VISIBLE,
  INDEX `fk_User_Evaluation_evaluated_idx` (`evaluated` ASC) VISIBLE,
  UNIQUE INDEX `evaluator_evaluated_UNIQUE` (`evaluator` ASC, `evaluated` ASC) VISIBLE,
  INDEX `evaluated_grade_index` (`evaluated` ASC, `grade` ASC) VISIBLE,
  CONSTRAINT `fk_Grade_User1`
    FOREIGN KEY (`evaluator`)
    REFERENCES `makemeacube`.`User` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Grade_User2`
