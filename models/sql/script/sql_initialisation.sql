...
CREATE TABLE IF NOT EXISTS `makemeacube`.`MakerTool` (
  ...
  `makerToolType` VARCHAR(1) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `makemeacube`.`Printer3D` (
  ...
  `xAccuracy` DECIMAL(6,6) NOT NULL,
  `yAccuracy` DECIMAL(6,6) NOT NULL,
  `zAccuracy` DECIMAL(6,6) NOT NULL,
  `layerThickness` DECIMAL(6,6) NOT NULL,
